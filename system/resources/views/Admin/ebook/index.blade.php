                                        ...
                                        <td>
                                            <center>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="{{ url('Admin/ebook/update', $ebook->id) }}" class="btn btn-sm btn-primary">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="{{ url('Admin/ebook/hapus', $ebook) }}" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data ini ?!')">
